...
Menu.Colors = {
    HeaderPink = { r = 199, g = 154, b = 59 },
    SelectedBg = { r = 199, g = 154, b = 59 },
    TextWhite = { r = 255, g = 255, b = 255 },
    BackgroundDark = { r = 10, g = 17, b = 40 },
    FooterBlack = { r = 10, g = 17, b = 40 }
}
...
function Menu.ApplyTheme(themeName)
    ...
    if themeLower == "red" then
        Menu.Colors.HeaderPink = { r = 199, g = 154, b = 59 }
        Menu.Colors.SelectedBg = { r = 199, g = 154, b = 59 }
        Menu.Banner.imageUrl = "https://i.imgur.com/A0TnMrH.jpeg"
    ...
    elseif themeLower == "pink" then
        ...
        Menu.Colors.HeaderPink = { r = 148, g = 0, b = 211 }
        Menu.Colors.SelectedBg = { r = 148, g = 0, b = 211 }
        Menu.Banner.imageUrl = "https://i.imgur.com/fs5Hc5R.png"
        Menu.CurrentTheme = "Purple"
    end
